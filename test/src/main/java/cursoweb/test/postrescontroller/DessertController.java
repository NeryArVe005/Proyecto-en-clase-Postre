package cursoweb.test.postrescontroller;
...
import cursoweb.test.*;

@RestController
//@CrossOrigin(origins = "*")

public class DessertController {
        ArrayList<Postres> desserts;
        

        public DessertController() {
                desserts = new ArrayList<Postres>();
                ...
                desserts.add(new Postres("3", "Tarta Chocolate", "5.00 €",
                                "https://i.ibb.co/bv8pP0J/Tortachocolate-id3.png",
                ...
                desserts.add(new Postres("5", "Pan de Centeno", "1.75 €",
                                "https://i.ibb.co/vsVkgB2/pandecenteno-id5.png",
                ...
                desserts.add(new Postres("6", "Helado de Vainilla", "3.25 €",
                                "https://i.ibb.co/yqsDWpx/Heladovainillaid6.png",
        ...
        public int insert(@RequestBody Postres newPostres) {
                int res = -1;
                try {
                        desserts.add(newPostres);
                        res = 1;
        ...
        @DeleteMapping("/api/postres/delete")
        public int delete(@RequestParam String name) {
                int res = -1;
                try {
                        desserts.removeIf(d -> (d.getName().equals(name)));
                        res = 1;
                } catch (RuntimeException ex) {
                        System.out.println(ex.getMessage());
                }
